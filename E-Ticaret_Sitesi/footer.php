			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						...
						<li class="fmobile"><?php echo $ayarcek['ayar_gsm'] ?><br>+387-123-456-2</li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;<?php echo $ayarcek['ayar_autor'] ?> <a href="http://222.joyakedemi.com">www.joyakademi.com</a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						...
						<a href="http://<?php echo $ayarcek['ayar_youtube'] ?>" class="ffacebook" class="fflickr">Youtube</a>
						<a href="http://<?php echo $ayarcek['ayar_google'] ?>" class="ffacebook" class="ffeed">Google</a>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				</div><!--footer Share-->
