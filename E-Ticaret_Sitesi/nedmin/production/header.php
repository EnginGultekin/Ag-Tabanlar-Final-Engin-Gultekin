...
// Session ile gelen mail bilgisini kullanarak tablodakli diğer verileri çekeceğiz 
...
<html lang="en">
  <head>
    ...
    <title>EngLeng E-Ticaret Sitesi </title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-anchor"></i> <span>EngLeng A.Ş.!</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/imgg.jpg" alt=""><?php echo $kullanicicek['kullanici_adsoyad']; ?>
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="images/imgg.jpg" alt="Profile Image" /></span>
                        <span>
