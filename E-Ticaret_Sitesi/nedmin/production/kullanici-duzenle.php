...
// Kullanıcı tablosundan Verileri çekeceğiz 
...
<!-- Burda form.html dosyasının üst kısmını sildik ve sadece işimize yarayacak olan alt kısmını aldık -->
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <!-- / en kök dizine gider ve ../ bir üst dizine gider-->
                    <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input disabled=""  type="date" id="first-name" name="kullanici_tarih" value="<?php echo $zaman[0]; ?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input disabled=""  type="time" id="first-name" name="kullanici_saat" value="<?php echo $zaman[1]; ?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
