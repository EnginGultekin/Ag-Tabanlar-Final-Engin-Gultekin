              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <img width="200"  src="../../<?php echo "EngLeng".$ayarcek['ayar_logo']; ?>">

                    <?php } else {?>


                    <img width="100"  src="../../dimg/logo-yok.png">
                    ...
                    <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="ayar_autor" 
                          value="<?php echo $ayarcek['ayar_autor'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
