...
// Burda Kullanıcı Kaydetme işlemlerini gerçekleştirdik
...
//Logo Düzenleme İşlemleri Koodları
...
if (isset($_POST['kullanicigiris'])) {
	...
	if ($say==1) {
		...
		header("Location:../../?durum=basarisizgiris");
				...
				//Genel-Ayar Dosyası İçin Güncelleme//

if (isset($_POST['genelayarkaydet'])) {
	
	// Tablo Güncelleme İşlem Kodları
	$ayarkaydet=$db->prepare("UPDATE ayar SET 

	ayar_title=:ayar_title,
	ayar_description=:ayar_description,
	ayar_keyword=:ayar_keyword,
	ayar_autor=:ayar_autor
	where ayar_id = 0 ");
	...
	if ($update) {
		...
		header("Location:../production/genel-ayar.php?durum=NO");
				...
				//İletişim-Ayarlar Dosyası İçin Güncelleme//
...
if (isset($_POST['iletisimayarkaydet'])) {
	...
	if ($update) {
		...
		header("Location:../production/iletisim-ayarlar.php?durum=NO");
				...
				//Api-Ayarlar Dosyası İçin Güncelleme//
...
if (isset($_POST['apiayarkaydet'])) {
	...
	if ($update) {
		...
		header("Location:../production/api-ayarlar.php?durum=NO");
				...
				//Sosyal-Ayarlar Dosyası İçin Güncelleme//
...
if (isset($_POST['sosyalayarkaydet'])) {
	...
	if ($update) {
		...
		header("Location:../production/sosyal-ayarlar.php?durum=NO");
				...
				//Mail-Ayarlar Dosyası İçin Güncelleme//
...
if (isset($_POST['mailayarkaydet'])) {
	...
	if ($update) {
		...
		header("Location:../production/mail-ayarlar.php?durum=NO");
				...
				//Hakkımızda Dosyası İçin Güncelleme//
...
//Kullanıcı-duzenle Doysaı için Güncelle//
...
//Kullanıcı-duzenle Doysaı için Sil//
...
// Menu Düzenle Sayfası için Güncelleme işlemleri //
...
// Menu Ekle Sayfası için Yeni Kayıt Ekleme işlemleri //
...
// Kategorileri Düzenlediğimiz alan Alan
...
// Argo İçeren Yorumları Silme İşlemleri
if ($_GET['yorumsil']=="OK") {
...
// Kullanıcı Şifresi Güncelleme İşlemleri 
if (isset($_POST['kullanicisifreguncelle'])) {
	...
	//eski şifre doğruysa başla
		...
		// Bitiş
			...
			header("Location:../../sifre-guncelle.php?durum=sifreleruyusmuyor");
...
// Ürünlerin Reimlerini Silme  İşlemleri
...
/* Burayı yukarda yaptık zaten

// Mail Kaydetme İşlemleri
if (isset($_POST['mailayarkaydet'])) {
